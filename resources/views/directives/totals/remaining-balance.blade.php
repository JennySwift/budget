<div ng-show="show.basic_totals">
    ...
    <table class="totals">
        ...
        <tr class="tooltipster" title="total of expense transactions that have no budget">
            ...
            <td><span ng-if="totalChanges.expensesWithoutBudget">[[totalChanges.expensesWithoutBudget | number:2]]</span></td>
        </tr>
        ...
        <tr class="tooltipster" title="total of allocation of tags of expense transactions that have a fixed budget before its starting date">
            ...
            <td><span ng-if="totalChanges.expensesWithFixedBudgetBeforeStartingDate">[[totalChanges.expensesWithFixedBudgetBeforeStartingDate | number:2]]</span></td>
        </tr>
        ...
        <tr class="tooltipster" title="total of allocation of tags of expense transactions that have a fixed budget after its starting date">
            ...
            <td><span ng-if="totalChanges.expensesWithFixedBudgetAfterStartingDate">[[totalChanges.expensesWithFixedBudgetAfterStartingDate | number:2]]</span></td>
        </tr>
        ...
        <tr class="tooltipster" title="total of allocation of tags of expense transactions that have a flex budget before its starting date">
            ...
            <td><span ng-if="totalChanges.expensesWithFlexBudgetBeforeStartingDate">[[totalChanges.expensesWithFlexBudgetBeforeStartingDate | number:2]]</span></td>
        </tr>

<div ng-show="show.budget_totals">
    ...
    <table class="totals">
        ...
        <tr class="tooltipster" title="fixed budget (total of fixed budget info column C)">
            ...
            <td><span ng-if="totalChanges.cumulativeFixedBudget">[[totalChanges.cumulativeFixedBudget | number:2]]</span></td>
        </tr>
        ...
        <tr class="tooltipster" title="total of allocation of tags of expense transactions that have a flex budget">
            ...
            <td><span ng-if="totalChanges.expensesWithFlexBudgetAfterStartingDate">[[totalChanges.expensesWithFlexBudgetAfterStartingDate | number:2]]</span></td>
        </tr>

    ...
    <div id="allocation-popup" class="popup-inner">
        ...
        <div id="allocation-table-container">
            <table class="table table-bordered">
                ...
                <!-- table content -->
                <tr ng-repeat="tag in new_transaction.tags" ng-if="tag.fixed_budget || tag.flex_budget">
        ...
        <div class="center-contents">
            <div class="checkbox-wrapper">
                ...
                <input ng-model="new_transaction_allocation_popup_transaction.allocation" ng-change="updateAllocationStatus()" type="checkbox">
            </div>
        </div>
        <!-- close button -->
        <button ng-click="show.new_transaction_allocation_popup = false" class="close-modal">Close</button>
    </div>
</div>
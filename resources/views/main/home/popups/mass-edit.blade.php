<div v-show="show.mass_edit" v-cloak class="popup-outer">
    <div class="popup-inner">
        <div class="row">
            ...
            <div class="col-sm-4">
                <button v-on:click="massEditTags()" id="mass-edit-add-tag-button" class="btn btn-info btn-xs">add tag(s)</button>
            </div>
        </div>
        <div class="row">
            <div class="my-dropdown-container col-sm-4">
            ...
            <div class="col-sm-4">
                <button v-on:click="massEditTags()" id="mass-edit-remove-tag-button" class="btn btn-info btn-xs">remove tag(s)</button>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <button v-on:click="massEditDescription()" id="mass-edit-description-button" class="btn btn-info btn-xs">edit description</button>
            </div>
        </div>
